...
export default function Testimonials() {
  ...
  return (
    <Reveal as="section" className="py-24 bg-navy-950 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <Reveal key={index} delay={index * 120}>
              <div className={`group relative p-8 rounded-2xl ${cardSurface} hover:border-white/15 transition-colors`}>
