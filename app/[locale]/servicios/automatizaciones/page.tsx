...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return createMetadata({
    ...
    title: 'SurLogic — Enterprise Automation',
    description: 'Automatización empresarial que reduce tiempos y errores en operaciones críticas.',
    ...
    <div className="pt-20">
      <section className="py-24 bg-gradient-to-b from-navy-950 to-navy-900 text-center">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 space-y-4">
          <p className="inline-flex px-4 py-1.5 rounded-full text-sm font-medium text-emerald-200 bg-emerald-500/10 border border-emerald-500/20">
            {t('hero.title')}
          </p>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-500/10 to-teal-500/10">
