    ...
    <div className="pt-20">
      ...
      <section className="py-16 sm:py-20 bg-navy-900">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 space-y-8">
          <article className={`rounded-2xl ${cardSurface} overflow-hidden transition-colors hover:border-blue-400/40`}>
            <div className="grid grid-cols-1 md:grid-cols-[1.1fr,0.9fr]">
              ...
              <div className="p-8 md:p-10 bg-white/5">
                ...
                <div className="mt-6">
                  <div className="text-sm text-gray-400 font-semibold uppercase tracking-wide mb-3">
                    {t('mariaCarissima.stack')}
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {[1, 2, 3, 4, 5, 6].map((n) => (
                      <span key={n} className="text-xs text-blue-100 bg-blue-500/10 border border-blue-500/20 px-2.5 py-1 rounded-md">
                        {t(`mariaCarissima.stackItem${n}`)}
                      </span>
                    ))}
                  </div>
                </div>
          ...
          <div className={`rounded-2xl ${cardSurface} p-8 md:p-10 bg-gradient-to-r from-navy-950 to-navy-900`}>
